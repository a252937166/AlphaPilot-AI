...
def _serialize_full_breadth(
    ...
    return {
        ...
        "prior_advancers": previous.advancers if previous is not None else None,
        "prior_decliners": previous.decliners if previous is not None else None,
        "prior_unchanged": previous.unchanged if previous is not None else None,
        "prior_limit_up": previous.limit_up if previous is not None else None,
        "prior_limit_down": previous.limit_down if previous is not None else None,
